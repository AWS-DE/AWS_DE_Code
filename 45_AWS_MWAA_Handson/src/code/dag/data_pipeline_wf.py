...
config = {
    ...
    'Targets':{'S3Targets' : [{'Path': "s3://aws-de-mwaa/curated-data/" }]}
}
...
with DAG(
    ...
    purge_processed_data_s3_objects = BashOperator(
        ...
        bash_command=f'aws s3 rm s3://aws-de-mwaa/processed-data/ --recursive',
    )
    ...
    run_glue_job = GlueJobOperator(
        ...
        script_location="s3://aws-de-mwaa/scripts/glue_etl.py",
        s3_bucket="aws-de-mwaa",
    ...
    sync_buckets = BashOperator(
        ...
        bash_command='aws s3 sync s3://aws-de-mwaa/landing-zone/  s3://aws-de-mwaa/processed-data/',
    )
    ...
    purge_raw_data_file = S3DeleteObjectsOperator(
        ...
        bucket="aws-de-mwaa",
        keys=["landing-zone/carsdata.csv"],
        aws_conn_id="aws_default",
    ) 
